...
- **Adaptive substitutions (`adaptive.h`, `ADAPTIVE_TERM` 200ms)** — two keys typed in quick succession on BASE produce a third key instead, disabled on CRYL and when any Ctrl/Alt/Gui mod is held:
